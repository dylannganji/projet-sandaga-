...
const notification = require('./assets/image/notifications.png')
const add = require('./assets/image/add.png')
const up = require('./assets/image/haut.png')
const crayon = require('./assets/image/edit.png')
const next = require('./assets/image/suivant.png')
const pp = require('./assets/image/pp.jpg')
const graphe = require('./assets/image/graphe (1).png')
            ...
            <view style={styles.app}>
                ...
                <ScrollView horizontal={true}>
                    {slides.map((slide, index) => (
                        <View key={index} style={{ width: '55%', height: 200, }}>
